...
async def start_comm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker("CAACAgIAAxkBAAECsQ5louDPxfqF2PuDvGX1VHQvbzv6LAACzhUAAoQMWErFKYCqGkCdUh4E")
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/R_i_O_Q) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
            ...
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="𝗦𝗼𝘂𝗿𝗰𝗲 𝗧𝗲𝘁𝗼", url="https://t.me/WX_PM"
                        ),
                    ],
                ]
            )
